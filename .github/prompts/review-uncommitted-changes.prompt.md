...
3. Iterate through the list of changes and new files. For new files, read the full file content to understand the changes.
4. Report only confirmed hard logical errors: crashes, data loss, wrong business logic, broken contracts, security issues. Ignore style, formatting, and missing tests.
5. Do NOT change code without confirmation
